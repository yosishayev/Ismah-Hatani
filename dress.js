...
$(document).ready(function () {
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            display_dress(JSON.parse(response));
        },
...
//display dress photos and details
function display_dress(data) {
    let j = 0;
    ...
    for (let i = 0; i < data.length / 3; i++) {
        ...
        for (let k = 0; k < 3; k++, j++) {
            ...
            if (j == data.length)
                break;
            console.log(data[j]);
            let dress_div = document.createElement("div");
            dress_div.className = "sup_div";
            ...
            img.src = "images/dress/" + data[j].full_name + ".jpg";
            ...
            r_div.appendChild(dress_div);
            dress_div.appendChild(a);
            dress_div.appendChild(text_div);
